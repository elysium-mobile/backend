...
public class SurveyAssembler {
    ...
    public static CreateSurveyCommand toCommandFromRequest(CreateSurveyRequest request) {
        return new CreateSurveyCommand(request.title(), request.description(), request.targetType(), request.expirationTime());
    }
    ...
    public static UpdateSurveyCommand toCommandFromRequest(Long surveyId, UpdateSurveyRequest request) {
        return new UpdateSurveyCommand(surveyId, request.title(), request.description(), request.targetType(), request.expirationTime());
    }
    ...
    public static SurveyResponse toResponseFromEntity(Survey survey) {
        return new SurveyResponse(survey.getId(), survey.getTitle(), survey.getDescription(), survey.getTargetType(), survey.getExpirationTime());
    }
}
