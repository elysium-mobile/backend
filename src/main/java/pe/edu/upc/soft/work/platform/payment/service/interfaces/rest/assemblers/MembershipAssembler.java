...
public class MembershipAssembler {
    ...
    public static CreateMembershipCommand toCommandFromRequest(CreateMembershipRequest request) {
        return new CreateMembershipCommand(request.membershipStart(), request.membershipOver(), request.membershipStatus());
    }
    ...
    public static UpdateMembershipCommand toCommandFromRequest(Long membershipId, UpdateMembershipRequest request) {
        return new UpdateMembershipCommand(membershipId, request.membershipStart(), request.membershipOver(), request.membershipStatus());
    }
    ...
    public static MembershipResponse toResponseFromEntity(Membership membership) {
        return new MembershipResponse(membership.getId(), membership.getMembershipStart(), membership.getMembershipOver(), membership.getMembershipStatus());
    }
}
