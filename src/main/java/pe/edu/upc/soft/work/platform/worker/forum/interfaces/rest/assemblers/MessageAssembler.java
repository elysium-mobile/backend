...
public class MessageAssembler {
    ...
    public static CreateMessageCommand toCommandFromRequest(CreateMessageRequest request) {
        return new CreateMessageCommand(new UserAccountId(request.userAccountId()), request.contentMessage());
    }
    ...
    public static MessageResponse toResponseFromEntity(Message message) {
        return new MessageResponse(message.getId(), message.getUserAccountId().userAccountId(), message.getContentMessage());
    }
}
